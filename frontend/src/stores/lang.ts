...
const messages = {
  zh: {
    ...
    loadError: '项目列表加载失败，请刷新页面',
    renameError: '重命名失败，请重试',
    deleteError: '删除失败，请重试',
    enterCreate: '进入创作',
    confirmDeleteMsg: '此操作不可恢复，确认删除该项目？',
    saveError: '保存失败，请重试',
    loginRequired: '需要登录',
    loginToGenerate: '登录或注册后即可保存项目、生成 MV',
    guestHint: '游客模式 · 对话不会保存',
    publishProject: '发布到广场',
    ...
    compareType: '类型',
    compareModels: '选择模型',
    comparePromptPlaceholder: '描述你想生成的内容...',
    compareStart: '开始对比',
    compareSelectModels: '请至少选择 2 个模型',
    compareEnterPrompt: '请输入提示词',
    compareStartError: '对比启动失败',
    comparePickSuccess: '已选择 {model} 版本！',
    comparePickError: '保存选择失败',
    compareQuality: '质量评分',
    comparePick: '选择此版本',
    compareNew: '新建对比',
  ...
  en: {
    ...
    loadError: 'Failed to load projects, please refresh',
    renameError: 'Rename failed, please try again',
    deleteError: 'Delete failed, please try again',
    enterCreate: 'Open Studio',
    confirmDeleteMsg: 'Cannot be undone. Delete this project?',
    saveError: 'Save failed, please try again',
    loginRequired: 'Login Required',
    loginToGenerate: 'Sign in or register to save your project and generate MV',
    guestHint: 'Guest mode · Chat is not saved',
    publishProject: 'Publish to Gallery',
    unpublishProject: 'Unpublish',
    publishSuccess: 'Published to gallery!',
    ...
    comparePromptPlaceholder: 'Describe what you want to generate...',
    compareStart: 'Start Comparison',
    compareSelectModels: 'Select at least 2 models',
    compareEnterPrompt: 'Enter a prompt',
    compareStartError: 'Failed to start comparison',
    comparePickSuccess: 'Selected {model} version!',
    comparePickError: 'Failed to save selection',
    compareQuality: 'Quality',
    comparePick: 'Pick This',
